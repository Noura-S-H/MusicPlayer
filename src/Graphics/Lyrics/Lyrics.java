...
public class Lyrics {
    ...
    public static List<String> getSongLyrics(String band, String songTitle) throws IOException {
        ...
        Document doc = Jsoup.connect(songLyricsURL+ "/"+band.replace(" ", "-").toLowerCase()+
                "/"+songTitle.replace(" ", "-").toLowerCase()+"-lyrics/").userAgent("Mozilla").get();
...
//        System.out.println(Lyrics.getSongLyrics("Billy Joel", "Allentown"));
//        System.out.println(Lyrics.getSongLyrics("Tori Amos", "Winter"));
//    }
}
